...
flowchart TD
    ...
    P1["Phase 1: Screening & Mandate Fit | 8 steps (2F/3P/3N)"]:::llmPartial
    ENTRY --> P1

    %% Phases 2-6 run in parallel after screening
    ...
    P4["Phase 4: Credit Modeling & Scenarios | 6 steps (0F/6P/0N)"]:::llmPartial
    P5["Phase 5: Relative Value & Total Return | 4 steps (0F/3P/1N)"]:::llmPartial
    P6["Phase 6: Legal & Structural Analysis | 3 steps (0F/3P/0N)"]:::llmPartial
    ...
    %% All parallel streams converge into validation
